L.AreaSelect = L.Class.extend({
    ...
    _createElements: function() {
        ...
        this._nwHandle = L.DomUtil.create("div", "leaflet-areaselect-handle leaflet-control handle-nw", this._container);
        this._swHandle = L.DomUtil.create("div", "leaflet-areaselect-handle leaflet-control handle-sw", this._container);
        this._neHandle = L.DomUtil.create("div", "leaflet-areaselect-handle leaflet-control handle-ne", this._container);
        this._seHandle = L.DomUtil.create("div", "leaflet-areaselect-handle leaflet-control handle-se", this._container);
    ...
    _setUpHandlerEvents: function(handle, xMod, yMod) {
        ...
        function onMouseDown(event) {
            ...
            L.DomEvent.removeListener(this, "touchstart mousedown", onMouseDown);
            ...
            function onMouseUp(event) {
                ...
                L.DomEvent.removeListener(mapContainer, "touchend mouseup", onMouseUp);
                L.DomEvent.removeListener(mapContainer, "touchmove mousemove", onMouseMove);
                L.DomEvent.addListener(handle, "touchstart mousedown", onMouseDown);
                self.fire("change");
            }
            L.DomEvent.addListener(mapContainer, "touchmove mousemove", onMouseMove);
            L.DomEvent.addListener(mapContainer, "touchend mouseup", onMouseUp);
        }
        L.DomEvent.on(handle, "touchstart mousedown", onMouseDown);
    },
